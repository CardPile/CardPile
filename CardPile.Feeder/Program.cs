...
class Program
{
    ...
    {
        const string DefaultSource = @"D:\Programming\GitHub\CardPile\Test data\Logs\Player_15_6_2024.log";
        const string DefaultDestination = @"D:\Programming\GitHub\CardPile\Test data\Logs\Player_fed.log";
